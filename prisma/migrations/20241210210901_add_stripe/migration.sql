/*
  ...
  - Added the required column `monthlyPaymentLink` to the `Plan` table without a default value. This is not possible if the table is not empty.
  ...
  - Added the required column `yearlyPaymentLink` to the `Plan` table without a default value. This is not possible if the table is not empty.
  - Added the required column `yearlyPriceId` to the `Plan` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE "Plan" ADD COLUMN     "monthlyPaymentLink" TEXT NOT NULL,
ADD COLUMN     "monthlyPriceId" TEXT NOT NULL,
ADD COLUMN     "yearlyPaymentLink" TEXT NOT NULL,
